                    ...
                    <Link key={item.href} href={item.href} onClick={onNavigate}>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                <span
                                    className={`rounded-lg p-1.5 ${isActive ? "bg-emerald-500/20 text-emerald-300" : "bg-muted/45 text-muted-foreground"
                                        }`}
                                >
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
            ...
            <div className="relative z-10 flex min-h-screen">
                <aside className="hidden w-72 shrink-0 border-r border-border/60 bg-card/60 backdrop-blur-xl lg:flex lg:flex-col">
                    ...
                    <header className="sticky top-0 z-30 border-b border-border/60 bg-background/80 backdrop-blur-xl">
                        <div className="mx-auto flex h-16 w-full max-w-7xl items-center justify-between px-4 md:px-6 lg:px-8">
                            ...
                            <div className="flex items-center gap-2">
                                <Badge
                                    className={isPro
                                        ? "hidden border-emerald-500/35 bg-emerald-500/15 text-emerald-300 sm:inline-flex"
